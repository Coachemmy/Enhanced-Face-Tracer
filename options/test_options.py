...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--model_path', type=str, default='', help='model file path')
		...
		self.parser.add_argument('--quality', type=str, default='new_swaps', help='the quality or the base type of input images')
		...
		self.parser.add_argument('--net_type', type=str, default='vit_s_mix', help='the base disentangle network structure')
