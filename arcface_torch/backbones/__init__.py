from .iresnet import iresnet18, iresnet34, iresnet50, iresnet100, iresnet200, iresnet50_mix, iresnet18_mix
...
def get_model(name, **kwargs):
    ...
    if name == "r18":
        ...
        return iresnet18_mix(False, **kwargs)
    elif name == "r50_mix":
        return iresnet50_mix(False, **kwargs)
    elif name == "r2060":
        ...
        num_features = kwargs.get("num_features", 512)
        from .vit import VisionTransformer_Mix
        return VisionTransformer_Mix(
            img_size=112, patch_size=9, num_classes=num_features, embed_dim=512, depth=12,
            num_heads=8, drop_path_rate=0.1, norm_layer="ln", mask_ratio=0.1)
        ...
        from .vit import VisionTransformer
        return VisionTransformer(
            img_size=112,        # match your training images
            patch_size=9,        # match checkpoint
            num_classes=num_features,
            embed_dim=512,       # match checkpoint embed_dim
